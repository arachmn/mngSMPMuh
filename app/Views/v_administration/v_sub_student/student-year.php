...
<body>
                ...
                <div class="row">
                    <div class="col mb-20">
                        <div class="card-box pd-20">
                            <div class="h5 mb-3 d-inline">List Tahun Ajaran</div>
                            <div class="d-inline" style="float: right;">
                                <button class="btn btn-outline-primary" id="addSiswa" onclick="openAddYear()">
    ...
    <script type="text/javascript">
        ...
        function reload_year() {
            $.ajax({
                url: "<?= site_url('AdministrationController/studentYearData') ?>",
                beforeSend: function(f) {
                    $('.btn-list').html(loader);
                },
        ...
        function openAddYear(idClass, a) {
            Swal.fire({
                icon: 'warning',
                title: 'Tambah Data',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?= site_url('AdministrationController/saveClassYear') ?>",
                        success: function(data) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Sukses!',
