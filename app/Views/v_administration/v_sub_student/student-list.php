...
<body>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Siswa Kelas <?= $class ?> | <?= $year ?></h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= site_url('administration/student/' . $year) ?>">Kelas</a></li>
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h5 class="h4 text-blue mb-20 d-inline">List Siswa</h5>
                        <div class="d-inline" style="float: right;">
                            <button class="btn btn-outline-primary" id="addSiswa" onclick="openAddStudent()">
                                <i class="bi bi-pencil-square" style="font-size: 20px;"></i>
                            </button>
                        </div>
                    </div>
                    <div id="tableStudent" class="mt-3" style="overflow: auto;">
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function reload_table(num) {
            $.ajax({
                url: "<?= site_url('AdministrationController/studentListData/' . $idClass) ?>",
                beforeSend: function(f) {
                    $('#tableStudent').html(loader);
                },
                success: function(data) {
