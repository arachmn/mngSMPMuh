...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= site_url('administration/subject') ?>">Tahun Ajaran</a></li>
    ...
    <script type="text/javascript">
        ...
        function reload_class_vii() {
            $.ajax({
                url: "<?= site_url('AdministrationController/subjectClassVIIData/' . $year) ?>",
        ...
        function reload_class_viii() {
            $.ajax({
                url: "<?= site_url('AdministrationController/subjectClassVIIIData/' . $year) ?>",
                beforeSend: function(f) {
        ...
        function reload_class_ix() {
            $.ajax({
                url: "<?= site_url('AdministrationController/subjectClassIXData/' . $year) ?>",
                beforeSend: function(f) {
                    $('#dataIX').html(loader);
                },
                success: function(data) {
