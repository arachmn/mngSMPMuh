...
<body>
                ...
                <div class="pd-20 card-box mb-30">
                    <?php if ($master == 'yes') : ?>
                        ...
                        <div class="d-inline" style="float: right;">
                            <a class="btn btn-outline-primary" id="teacherMaster" name="teacherMaster" href="<?= site_url('teacher/subject/' . $year . '/all') ?>">
                                <i class="fa fa-exchange" style="font-size: 20px;"></i>
                            </a>
                        </div>
                    <?php else : ?>
                        <h5 class="h4 text-blue mb-20">List Mata Pelajaran</h5>
                    <?php endif ?>
                    <div class="tab <?= $master == 'yes' ? 'mt-3' : '' ?>">
                        <ul class="nav nav-tabs customtab" role="tablist">
                            ...
                            <?php if ($VIII > 0) : ?>
                                <li class="nav-item">
                                    <a class="nav-link <?= $VIII > 0 && $VII == 0 ? 'active' : '' ?>" data-toggle="tab" href="#classVIII" role="tab" aria-selected="<?= $VIII > 0 && $VII == 0 ? 'true' : 'false' ?>">VIII</a>
                                </li>
                            <?php endif ?>
                            <?php if ($IX > 0) : ?>
                                <li class="nav-item">
                                    <a class="nav-link <?= $IX > 0 && $VIII == 0 && $VII == 0 ? 'active' : '' ?>" data-toggle="tab" href="#classIX" role="tab" aria-selected="<?= $IX > 0 && $VIII == 0 && $VII == 0 ? 'true' : 'false' ?>">IX</a>
                                </li>
                            <?php endif ?>
                        </ul>
                        <div class="tab-content">
                            ...
                            <?php endif ?>
                            <?php if ($VIII > 0) : ?>
                                <div class="tab-pane fade <?= $VIII > 0 && $VII == 0 ? 'show active' : '' ?>" id="classVIII" role="tabpanel">
                                    <div class="pd-20">
                            ...
                            <?php endif ?>
                            <?php if ($IX > 0) : ?>
                                <div class="tab-pane fade <?= $IX > 0 && $VIII == 0 && $VII == 0 ? 'show active' : '' ?>" id="classIX" role="tabpanel">
                                    <div class="pd-20">
    ...
    <script type="text/javascript">
        ...
        function reload_VII() {
            $.ajax({
                url: "<?= site_url('TeacherController/subjectListDataVII/' . $year) ?>",
        ...
        function reload_VIII() {
            $.ajax({
                url: "<?= site_url('TeacherController/subjectListDataVIII/' . $year) ?>",
                beforeSend: function(f) {
        ...
        function reload_IX() {
            $.ajax({
                url: "<?= site_url('TeacherController/subjectListDataIX/' . $year) ?>",
                beforeSend: function(f) {
